...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <a href="dashbord.php" class="navbar-text"><?php echo $contacts['name'] ?> </a>
    </div>
    <div class="collapse navbar-collapse" id="navbarText">
    ...
    <div class="container d-flex justify-content-center">
      <div class="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-6 col-xxl-5">
        <div class="auth-card" style="height: 450px; width: 600px">
          <h1 class="d-flex justify-content-center txt" style="font-size: 60px;">Welcome,<?php echo $contacts['name'] ?>!</h1>
          <br /><br />
          <div class="d-flex" style="justify-content: space-evenly;align-items: center;">
            <h4 class="txt">Your Profile:</h4>
            <img src="./Assets/img/student-img(1).png" style="width: 80px; height: 80px; border-radius: 50%" alt="" />
          </div>
          <br /><br />
          ...
          <table class="table" style="justify-content: center;">
            <thead>
              ...
              <tr class="txt">
                ...
                <th href="dashbord.php" scope="col" style="font-weight: lighter;"><?php echo $contacts['name'] ?></th>
              </tr>
              <tr class="txt">
                <th scope="col" style="font-weight: bolder;">Signup date :</th>

                <th scope="col" style="font-weight: lighter;"><?php echo $contacts['date'] ?> </th>
              </tr>
              <tr class="txt">
                <th scope="col" style="font-weight: bolder;">Last login :</th>

                <th scope="col" style="font-weight: lighter;"><?php echo $_SESSION['time'] ?></th>
              </tr>
            </thead>
          </table>
        </div>
